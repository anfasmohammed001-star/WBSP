...
const authService = {
    async register (email, password, userType, fullName) {
        ...
        if (data.user) {
            const { error: profileError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('users').insert({
                id: data.user.id,
                email: email,
                user_type: userType,
                full_name: fullName
    ...
    async getCurrentUser () {
        ...
        const { data: profile } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('users').select('*').eq('id', user.id).single();
        ...
        "AuthProvider.useEffect": ()=>{
            ...
            const checkSession = {
                "AuthProvider.useEffect.checkSession": async ()=>{
                    try {
                        const user = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$authService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authService"].getCurrentUser();
                        if (user) {
                            setState({
                                user: user,
            ...
            const { data: { subscription } } = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].auth.onAuthStateChange({
                "AuthProvider.useEffect": async (event, _session)=>{
...
_s(AuthProvider, "6nxe4loee6SgHzEIcemTpL9/dxc=");
_c = AuthProvider;
function useAuth() {
    _s1();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ThemeProvider.useEffect": ()=>{
            ...
            if (pathname.startsWith('/worker')) {
                ...
                const isLightRoute = WORKER_LIGHT_ROUTES.some({
                    "ThemeProvider.useEffect.isLightRoute": (route)=>pathname.includes(route)
                }["ThemeProvider.useEffect.isLightRoute"]);
                if (isLightRoute) {
                    targetTheme = 'light';
                }
            }
...
_s(ThemeProvider, "o5j602ys5rcQN22cGHc9DPauU9M=", false, function() {
    return [
...
function Providers({ children }) {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useAuth$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AuthProvider"], {
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useTheme$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ThemeProvider"], {
            children: [
                children,
...
//# sourceMappingURL=src_2a7ea0a5._.js.map