...
import { ChevronLeft, Crown, Trophy, Medal, Search, Star } from 'lucide-react';
                    ...
                    >
                        ...
                        <div className="flex-1 min-w-0">
                            ...
                            <div className="flex items-center space-x-3 mt-1 text-xs font-medium text-muted-foreground">
                                ...
                                <span className="flex items-center"><Star className="h-3 w-3 mr-1 text-yellow-500" /> {worker.rating}</span>
                            </div>
                        </div>
                    ...
                    <div className="space-y-3">
                        {[4, 5, 6, 7].map(i => (
                            <div key={i} className="flex items-center p-3 rounded-2xl hover:bg-secondary transition-colors cursor-pointer">
                                ...
                                <div className="font-bold text-sm">4.8 <Star className="h-3 w-3 inline text-yellow-500 -mt-0.5" /></div>
                            </div>
                        ))}
                    </div>
                </div>
