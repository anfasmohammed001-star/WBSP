...
import { Wallet, CheckCircle, Clock, MapPin, Bookmark, TrendingUp, Sparkles, Zap, Navigation, Plus, ChevronRight, Search } from 'lucide-react';
        ...
        <div className="min-h-screen pb-32 text-foreground relative overflow-hidden bg-[#020408]">
            ...
            <section className="px-6 mt-10 relative z-10">
                <div className="grid grid-cols-2 gap-5 mb-5">
                    ...
                    <motion.div
                        ...
                        whileHover={{ scale: 1.02 }}
                        whileTap={{ scale: 0.98 }}
                        onClick={() => navigate('/worker/academy')}
                        className="cursor-pointer"
                    >
                        <Card className="glass-obsidian overflow-hidden border-none relative group">
                            <div className="absolute top-0 right-0 p-4 opacity-5 group-hover:opacity-10 transition-opacity">
                ...
                {/* Daily Yield Progress & Reputation - NEW FEATURE */}
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mt-5">
                    ...
                    >
                        <Card className="glass-obsidian border-white/5 p-6">
                            <div className="flex justify-between items-center mb-4">
                                <span className="text-[10px] font-black uppercase tracking-widest text-white/30">Daily Objective</span>
                                <span className="text-[10px] font-black text-primary">72% Complete</span>
                            </div>
                            <div className="h-2 w-full bg-white/5 rounded-full overflow-hidden border border-white/10 mb-2">
                                <motion.div
                                    ...
                                    className="h-full bg-gradient-to-r from-primary to-blue-400 shadow-[0_0_10px_rgba(37,99,235,0.5)]"
                                />
                            </div>
                            <p className="text-[9px] font-bold text-white/20 uppercase tracking-widest text-center mt-3">Target: $400.00 / Remaining: $112.00</p>
                        </Card>
                    </motion.div>
                    ...
                    >
                        <Card className="glass-obsidian border-white/5 p-6 overflow-hidden relative group">
                            <div className="absolute top-0 right-0 p-4 opacity-10 group-hover:scale-110 transition-transform">
                                <Sparkles className="w-12 h-12 text-purple-500" />
                            </div>
                            <span className="text-[10px] font-black uppercase tracking-widest text-white/30 mb-4 block">Reputation Matrix</span>
                            <div className="flex gap-3 overflow-x-auto pb-2 mask-fade-edges scrollbar-hide">
                                {['Fast Responder', 'Elite Operative', 'Secure Link', 'High Precision'].map((badge, idx) => (
                                    <div key={idx} className="shrink-0 flex flex-col items-center gap-2">
                                        <div className="w-10 h-10 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center text-sm shadow-inner group-hover:border-primary/50 transition-colors">
                                            {idx === 0 ? '⚡' : idx === 1 ? '💎' : idx === 2 ? '🔒' : '🎯'}
                                        </div>
                                        <span className="text-[7px] font-black uppercase text-white/20 tracking-tighter w-12 text-center leading-none">{badge}</span>
                                    </div>
                                ))}
                            </div>
                        </Card>
            ...
            <section className="px-6 mt-12 relative z-10">
                ...
                <motion.div
                    ...
                    className="mt-10"
                >
                    <Card className="glass-obsidian border-primary/20 overflow-hidden relative">
                            ...
                            <div className="flex justify-between items-start mb-6">
                                <div>
                                    <div className="flex items-center gap-2 mb-2">
                                        ...
                                        <span className="text-[10px] font-black uppercase tracking-[0.3em] text-primary">High Demand Alert</span>
                                    </div>
                                    <h3 className="text-2xl font-black text-white tracking-tight">Sector 7 Matrix Boost</h3>
                                    <p className="text-white/40 text-xs font-medium">Earn +25% Yield in Downtown Manhattan for the next 2 hours.</p>
                                </div>
                                <Button variant="outline" size="sm" className="border-primary/20 bg-primary/5 text-primary font-black uppercase tracking-widest text-[10px]">Deploy Now</Button>
                            </div>

                            <div className="relative h-32 rounded-2xl bg-white/5 border border-white/5 overflow-hidden group">
                                ...
                                <div className="absolute bottom-3 left-3 px-3 py-1.5 rounded-lg bg-black/60 backdrop-blur-md border border-white/10 flex items-center gap-2">
                                    <div className="w-1.5 h-1.5 rounded-full bg-emerald-500 animate-pulse" />
                                    <span className="text-[8px] font-black text-white/60 tracking-widest uppercase">4 Elite Operatives En Route</span>
                                </div>
                            </div>
                        </CardContent>
                    </Card>
